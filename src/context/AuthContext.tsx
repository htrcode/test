...
const INITIAL_APPLICATIONS: Application[] = [
  {
    ...
    timeline: [
      ...
      { stage: 'Academic Eligibility Verified', timestamp: '13 Sep 2026, 02:15 PM', done: true, notes: 'Plus Two 84% marks verified against Calicut University criteria' },
      ...
      { stage: 'Provisional Admission Offer Letter Issued', timestamp: '14 Sep 2026, 09:10 AM', done: true, current: true, notes: 'Chathamkulam Institutional Grant of ₹15,000 allocated' },
