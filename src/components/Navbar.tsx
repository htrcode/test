        ...
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <nav className="hidden lg:flex items-center gap-0.5 xl:gap-1 shrink-0">
            <button
              ...
              className={`px-2 xl:px-3 py-1.5 xl:py-2 rounded-lg text-xs font-semibold transition flex items-center gap-1.5 cursor-pointer shrink-0 whitespace-nowrap ${
            ...
            <button
              ...
              className={`px-2 xl:px-3 py-1.5 xl:py-2 rounded-lg text-xs font-semibold transition flex items-center gap-1.5 relative cursor-pointer shrink-0 whitespace-nowrap ${
            ...
            <div className="relative shrink-0">
              <button
                ...
                className={`px-2 xl:px-3 py-1.5 xl:py-2 rounded-lg text-xs font-semibold transition flex items-center gap-1 cursor-pointer shrink-0 whitespace-nowrap ${
            ...
            {isLoggedIn ? (
              <div className="flex items-center gap-1.5 xl:gap-2 shrink-0">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200/80 border border-slate-200 transition cursor-pointer group shrink-0 text-left"
                  title="Click to edit your qualifications, budget & preferences"
                >
                  <div className="w-7 h-7 xl:w-8 xl:h-8 rounded-lg bg-gradient-to-tr from-indigo-500 to-blue-600 text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-xs">
                    {student.name.charAt(0)}
                  </div>
                  <div className="text-left hidden sm:block shrink-0">
                    <div className="flex items-center gap-1">
                      <span className="text-xs font-bold text-slate-800 group-hover:text-indigo-600 transition whitespace-nowrap max-w-[85px] xl:max-w-[130px] truncate block">
                        {student.name}
                      </span>
                  ...
                  <SlidersHorizontal className="w-3.5 h-3.5 text-slate-400 group-hover:text-indigo-600 transition shrink-0 hidden xl:block" />
                </button>

                {/* Clearly Labeled Sign Out Button */}
                <button
                  onClick={logout}
                  className="flex items-center gap-1.5 p-2 xl:px-3 xl:py-2 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 hover:text-rose-700 border border-rose-200/90 text-xs font-bold transition cursor-pointer shrink-0 shadow-xs"
                  title="Sign out of your account"
                >
                  <LogOut className="w-3.5 h-3.5 shrink-0" />
                  <span className="whitespace-nowrap hidden xl:inline">Sign Out</span>
                </button>
              </div>
            ) : (
              <div className="flex items-center gap-2">
