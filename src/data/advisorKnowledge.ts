/**
 * Master Academic Knowledge Base & Expert Advisory Engine for MARGEXA
 * Grounded in Kerala Higher Education, Chathamkulam Group of Institutions,
 * university admission guidelines, fee structures, and entrance exams.
 */

export const MARGEXA_KNOWLEDGE_BASE = `
...
- College Bus Transit Network: Dedicated fleet of buses connecting Palakkad Town, Ottapalam, Alathur, Mannarkkad, Chittur, Kozhinjampara, Walayar, and Kanjikode. Subsidized semester passes available.

===================================================================
2. STUDENT VIP MENTORSHIP & PRIORITY COUNSELING (MONTHLY PLAN: ₹349/MO)
===================================================================
- Single Monthly Plan: Just ₹349 per month. Students DO NOT pay every time they book or consult!
- What is Unlocked:
  1. Priority VIP Counseling: Guaranteed express callback or live video consultation within 20 minutes from senior admission officers.
  2. 1-on-1 Academic Mentorship: 30-minute private video strategy sessions with veteran academic deans, KTU/Calicut advisors, and recruiters.
- Senior Academic Mentors:
  * Prof. K. Sreedharan: Former Academic Dean & Calicut University Advisor, 28+ yrs experience. Expert in MBA/BBA career roadmaps, university allotment rules, and Chathamkulam quota admissions.
  * Er. Ananya Nair: Senior Tech Recruiter (Ex-TCS Innovation Labs), 12+ yrs experience. Expert in Polytechnic vs B.Tech decisions, IT careers in Infopark/Technopark, and LET entrance strategy.
  * Adv. Mathew Thomas: Higher Education Legal & Scholarship Specialist, 16+ yrs experience. Expert in E-Grantz, fee concessions, and regular vs distance degree legal validity.
- Subscription Features: Zero per-session fees during active month, instant slot booking, and unlimited consultations.
...
===================================================================
4. KERALA ENTRANCE EXAMINATIONS & ALLOTMENT PROCESSES
===================================================================
- KEAM (Kerala Engineering Architecture Medical): Conducted by CEE Kerala (cee.kerala.gov.in) for B.Tech merit seats. Merit list calculated using 50:50 ratio of KEAM entrance score + normalized Plus Two (+2) PCM marks.
- KMAT Kerala / CMAT / CAT: Mandatory eligibility exams for MBA admissions across Kerala universities. General qualifying cutoff is ~72 marks (10% of 720), with concessions for OBC/SC/ST.
- Kerala LET (Lateral Entry Test): Conducted by Directorate of Technical Education (DTE Kerala) for 3-year diploma holders seeking direct admission to 2nd year (3rd semester) B.Tech.
- DTE Polytechnic Single-Window Centralized Allotment Process (CAP): Online allotment based on SSLC/10th grade points.
- Calicut / MG / Kerala University CAP: Centralized allotment for undergraduate (UG) and postgraduate (PG) arts and science courses.
- Kerala PSC & KAS Eligibility: Any bachelor's degree awarded by a UGC-DEB recognized university (Regular or Distance) is 100% valid for Kerala PSC recruitment (Secretariat Assistant, Sub-Inspector, KAS, Village Extension Officer, etc.).

===================================================================
5. CAREER ROADMAPS & DEGREE COMPARISONS
===================================================================
- Polytechnic Diploma vs +2 Science:
  * 10th pass -> Polytechnic Diploma gives hands-on job skills in 3 years. Graduates can start earning at age 18-19 or enter 2nd year B.Tech via LET.
  * +2 Science keeps medical/pure science/engineering options open via entrance exams.
- BCA vs B.Tech Computer Science:
  * BCA is 3 years, cost-effective (₹35,000 - ₹45,000/yr), highly software-application oriented (Python, Web, DBMS). Leads directly to software developer jobs or 2-year MCA.
  * B.Tech CSE is 4 years, math and hardware-intensive, requires KEAM entrance.
- B.Com vs BBA:
  * B.Com focuses on accounting, auditing, taxation (Tally GST), banking, and preparation for CA/CMA/CS.
  * BBA focuses on general management, marketing, HR, entrepreneurship, and preparation for MBA.
- MBA in Logistics & Supply Chain:
  * High-growth domain in Kerala due to Cochin Port, ICTT Vallarpadam, Vizhinjam Deepwater Port, and direct trade routes to the GCC/Middle East.
...
/**
 * Intelligent domain expert engine that synthesizes rich, authoritative,
 * and profile-tailored answers for student queries.
 */
export function generateDomainExpertReply(query: string, student: any): string {
  const q = query.toLowerCase().trim();
  const name = student?.name || 'Student';
  const score = Number(student?.percentage) || 75;
  const rawBudget = Number(student?.budget) || 100000;
  ...
  if (
    ...
    q.includes('349') ||
    q.includes('priority counseling') ||
    q.includes('counselor call') ||
    q.includes('callback') ||
    q.includes('dean') ||
    q.includes('sreedharan') ||
    q.includes('ananya') ||
    q.includes('mathew thomas') ||
    q.includes('one on one') ||
    q.includes('1-on-1') ||
    q.includes('personal mentor')
  ) {
    return `### Student VIP Mentorship & Priority VIP Counseling (₹349/Month Plan)

Namaskaram **${name}**! MARGEXA provides a comprehensive **Student VIP Mentorship Plan** designed specifically so that **students do not have to pay every time they consult**!

* **Single Monthly Plan:** **₹349 per month** covers **both** key VIP features for 30 full days:
  1. **Priority VIP Counseling:** Guaranteed express callback or Google Meet video consultation **within 20 minutes** from a senior admissions counselor.
  2. **1-on-1 Academic Mentorship Sessions:** Private 30-minute strategic sessions with veteran deans, university advisors, and corporate recruiters.

* **Our Senior Academic Mentors (Included in Your ₹349 Plan):**
  * **Prof. K. Sreedharan:** Former Academic Dean & Calicut University Advisor (28+ Years Exp.). Specializes in MBA/BBA cutoffs, Calicut University CAP rules, and Chathamkulam quota allotments.
  * **Er. Ananya Nair:** Senior Tech Recruiter (Ex-TCS Innovation Labs, 12+ Years Exp.). Specializes in Polytechnic vs B.Tech choices, Lateral Entry (LET), and IT placements in Infopark & Technopark.
  * **Adv. Mathew Thomas:** Higher Education Legal & Scholarship Specialist (16+ Years Exp.). Guides students through E-Grantz, fee concession laws, and UGC-DEB distance degree equivalency.

* **Key Benefit:** You pay **₹349 once a month**. There are **zero per-session charges**. All your priority callbacks, admission reviews, and mentor sessions throughout the active subscription are 100% included!
...
Chathamkulam Business School (CBS) is an **AICTE-approved, Calicut University-affiliated** premier management campus in Palakkad, Kerala.

* **Program:** Master of Business Administration (MBA) - 2 Years (4 Semesters).
* **Industry-Integrated Dual Specializations (Select 2):**
  1. **Logistics & Supply Chain Management:** High recruitment demand driven by Cochin Port, ICTT Vallarpadam, Vizhinjam Transshipment Hub, Coimbatore logistics corridor, and Gulf trade.
  2. **Financial Management:** Corporate valuation, investment banking, equity research, FinTech, and banking operations.
  3. **Marketing Management:** Digital marketing, consumer analytics, brand building, FMCG distribution.
  4. **Human Resource Management (HR):** Talent acquisition, corporate labor laws, organizational psychology.
  5. **Systems / IT Management:** Business intelligence, ERP systems, and IT project governance.
...
* **Placements & Corporate Recruiter Network:**
  ...
  * Recruiters: Federal Bank, TCS, HDFC Bank, Muthoot Finance, Reliance Retail, Flipkart Logistics, DHL Express, Axis Bank, Ernst & Young, Cognizant.
  * Special Features: Free laptop, Bloomberg-standard live finance simulation lab, port internships in Kochi & Chennai.

You can secure a provisional MBA seat today with zero application fees on MARGEXA!`;
  }

  // 4. Polytechnic Engineering Diplomas & Lateral Entry to B.Tech
  if (
    ...
    return `### Polytechnic Engineering Diplomas & B.Tech Lateral Entry Pathways
...
* **Lateral Entry Pathways (How It Works):**
  ...
  * **Progressing from Diploma to B.Tech 2nd Year (Kerala LET):**
    - After completing your 3-year diploma with 45%+ marks, you can appear for the **Kerala Lateral Entry Test (LET)** conducted by DTE Kerala.
    - LET rank holders enter directly into the **2nd year (3rd semester)** of B.Tech across all KTU-affiliated government and private engineering colleges in Kerala, bypassing KEAM!

* **Career Opportunities:** Junior Engineer roles in Kanjikode Industrial belt, L&T, MRF, Tata Motors, Wipro Infrastructure, and Gulf engineering projects.`;
  }

  // 5. BCA vs B.Tech / Computer Science Guidance
  if (
    q.includes('bca') ||
    q.includes('b.tech cs') ||
    q.includes('btech cs') ||
    ...
    return `### BCA vs. B.Tech Computer Science: Detailed Career Comparison

Both pathways lead to lucrative software engineering careers in Infopark Kochi, Technopark Trivandrum, and Bangalore:
...
* **B.Tech Computer Science & Engineering:**
  - **Duration:** 4 Years.
  - **Focus:** Operating system internals, compiler design, computer architecture, algorithms, and theoretical computation.
  - **Eligibility:** +2 Science with 50%+ in Physics, Chemistry, Mathematics + KEAM entrance score.
...
Hostel accommodation and college bus routes across Palakkad are fully available for all Commerce students!`;
  ...
  if (
    ...
    return `### Distance Education vs. Regular Degree in Kerala: Complete PSC & Legal Validity

* **Is a Distance Degree Valid for Kerala PSC, UPSC, and Govt Exams?**
  - **YES, 100% LEGALLY VALID.** Under official Government of Kerala orders and University Grants Commission (UGC) regulations, degrees awarded by **UGC-DEB approved universities** hold complete legal equivalency to regular on-campus degrees.
  - Degrees from **Sree Narayanaguru Open University (SGOU, Kollam)** and **School of Distance Education (SDE) - University of Calicut** are recognized for:
    * Kerala PSC (Secretariat Assistant, Sub-Inspector, KAS, Panchayat Secretary).
    * UPSC Civil Services (IAS, IPS, IFS).
    * Banking exams (IBPS PO, SBI, RRB).
    * Post-graduate degree admissions across India.

* **Critical Restrictions (What Cannot Be Studied via Distance):**
  - Per AICTE, statutory council, and Supreme Court mandates, **technical and clinical degrees CANNOT be pursued via distance mode**:
    * B.Tech / Engineering Degrees
    * Polytechnic Diplomas
    * Nursing, Pharmacy, and Allied Health Sciences
...
* **When to Choose Distance vs. Regular:**
  ...
  * **Choose Regular (Chathamkulam Institutions):** If you desire active campus life, hands-on computer labs, daily faculty mentoring, peer networking, and **on-campus corporate placement drives**!`;
  ...
  if (
    ...
    q.includes('campus life') ||
    q.includes('safety') ||
    q.includes('palakkad campus')
  ) {
    return `### Chathamkulam Campus Hostels, Food & Bus Transit Network (Palakkad)
...
* **Hostel Accommodation:**
  - **Separate Hostels:** Secure, dedicated residential blocks for boys and girls.
  - **Safety:** 24/7 CCTV surveillance, biometric access, and resident faculty wardens.
  - **Room Facilities:** 2-sharing and 3-sharing ventilated rooms with individual study tables, wardrobes, high-speed Wi-Fi, and 24/7 backup power.
  - **Mess & Cuisine:** Wholesome, balanced South Indian and Kerala food (both vegetarian and non-vegetarian options prepared under strict hygiene standards).
  - **Monthly Charges:** Approximately **₹4,500 - ₹5,500 per month** covering both room accommodation and mess food.

* **College Bus Network:**
  - Fleet of college buses operating along primary transit corridors across Palakkad and border areas:
    ...
    * **Route 6:** Walayar - Kanjikode Industrial Belt - Campus

Day scholars can easily commute from anywhere in Palakkad district with subsidized semester bus passes!`;
  }

  // 9. Partner Colleges in Kerala (Rajagiri, TKM, Farook, Govt Poly, etc.)
  if (
    q.includes('rajagiri') ||
    q.includes('tkm') ||
    q.includes('farook') ||
    q.includes('govt poly') ||
    q.includes('government polytechnic') ||
    q.includes('amrita') ||
    q.includes('scms') ||
    q.includes('st teresa') ||
    q.includes('partner college')
  ) {
    return `### Premier Partner Colleges on MARGEXA

MARGEXA connects you with leading higher education institutions across Kerala:

1. **Chathamkulam Group of Institutions (Palakkad) - Flagship Partner:**
   - AICTE-approved MBA, Polytechnic Diplomas, and Calicut University Degrees (BCA, B.Com, BBA).
   - Direct provisional allotment and up to 50% merit scholarships on MARGEXA.

2. **Rajagiri College of Social Sciences (Kochi):**
   - Autonomous, NAAC A++ rated. Renowned for MBA, MCA, MSW, B.Com, and BBA with stellar corporate placements.

3. **TKM College of Engineering (Kollam):**
   - Premier government-aided engineering college affiliated to KTU. Gateway for B.Tech CSE, Civil, Mechanical via KEAM merit quota.

4. **Farook College Autonomous (Kozhikode):**
   - Elite Calicut University institution offering traditional and innovative UG/PG programs in Science, Arts, and Commerce.

5. **Government Polytechnic College (Palakkad):**
   - DTE Kerala institution offering highly subsidized diplomas (<₹5,000/yr) in Electronics, Civil, Mechanical, and Instrumentation.

6. **SCMS Cochin School of Business (Aluva):**
   - Premier management institute offering PGDM/MBA programs with specialized corporate internships.

Explore all colleges and compare fees side-by-side in the **Colleges** tab!`;
  }

  // 10. Kerala Entrance Exams (KEAM, KMAT, LET, NEET, CUET)
  if (
    q.includes('keam') ||
    q.includes('entrance') ||
    q.includes('cutoff') ||
    ...
    return `### Kerala Higher Education Entrance Exams & Cutoff Guide

Here are the key entrance examinations governing admissions in Kerala:

* **KEAM (CEE Kerala) - For B.Tech Engineering:**
  - Conducted annually by the Commissioner for Entrance Examinations (CEE Kerala).
  - **Ranking System:** 50% weightage given to KEAM entrance score + 50% weightage given to normalized marks in Plus Two (+2) Physics, Chemistry, and Mathematics (PCM).
  - Allotment is conducted through the Centralized Allotment Process (CAP) across multiple rounds.

* **KMAT Kerala / CMAT / CAT - For MBA:**
  - Mandatory entrance test for MBA admission into Calicut University, KTU, and MG University affiliated business schools.
  - **General Cutoff:** Minimum 10% (72 marks out of 720) for General category; 7.5% for SEBC; 5% for SC/ST.
  - Chathamkulam Business School accepts KMAT Kerala, CMAT, and CAT scores.

* **Kerala LET (Lateral Entry Test) - For B.Tech 2nd Year:**
  - Conducted by DTE Kerala for 3-year engineering diploma holders.
  - Exam covers Engineering Mathematics, basic electrical, electronics, mechanics, and computer concepts.
  - Qualified candidates enter directly into the 2nd year (3rd semester) of B.Tech.

If you haven't taken an entrance exam yet, Chathamkulam Group of Institutions provides direct institutional counseling allotments for eligible students!`;
  }

  // 11. Low Marks / Average Marks / Supplementary Guidance
  if (
    q.includes('low mark') ||
    q.includes('low percentage') ||
    q.includes('average mark') ||
    q.includes('failed') ||
    ...
    return `### Admission Pathways for Average Marks & Supplementary Candidates
...
For personal seat reservation guidance, contact our Admissions Desk at **+91 94470 12389**!`;
  }

  // 12. Guidance Center & Consultancy Franchise Network
  if (
    q.includes('guidance center') ||
...
* **Partnership Tiers:**
  ...
  2. **Gold Certified Partner (₹19,999/Month):**
     - **₹10,000 Referral Commission** per student admission.
     - Dedicated co-branded student dashboard and priority liaison desk for Chathamkulam Institutions.
     - Digital marketing collaterals and statewide student lead sharing.
  3. **Platinum Master Franchise (₹49,999/Month):**
     - **₹15,000 Referral Commission** per student admission.
     - **Exclusive territorial rights** for your taluk/district.
     - Direct hotline to college registrars and guaranteed quota seat reservations.
     - Bi-weekly commission payouts and joint admission seminars.

Guidance centers can calculate projected earnings and register in the **Guidance Partners** tab!`;
  }

  // 13. High-ROI Courses Matching Student's Exact Budget
  if (
    q.includes('budget') ||
    ...
    return `### Highest-ROI Degree & Diploma Programs Under Your Budget (${budget}/year)
...
You can apply for any of these options directly from your MARGEXA dashboard!`;
  ...
  // 14. Admission Procedures, Dates & Documents Required
  if (
    q.includes('document') ||
    ...
    return `### Kerala Higher Education Admissions: Application Steps & Required Documents

* **Mandatory Documents Required for Verification:**
  1. 10th Standard / SSLC Mark List & Certificate.
...
I have analyzed your academic profile:
...
What specific course, college, or admission doubt would you like to explore today?`;
  ...
  // 16. Comprehensive Contextual Fallback
  return `Thank you for your question, **${name}**!

Here is tailored guidance based on your academic profile:
